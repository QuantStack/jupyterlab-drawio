...
EXPORT_MIME_MAP.set(PNG_EDITABLE.mimetype, PNG_EDITABLE);
EXPORT_MIME_MAP.set(SVG_EDITABLE.mimetype, SVG_EDITABLE);
EXPORT_MIME_MAP.set(HTML_EDITABLE.mimetype, HTML_EDITABLE);
